...
title: Groq
description: >-
  Groq provides ultra-fast inference APIs for large language models with a focus
...
whenToUse: >-
  Use Groq when you need fast, low-latency LLM inference for prototypes, demos,
  or early-stage product development.
whenNotToUse: >-
  Avoid if you require access to a wide variety of models, higher token limits,
  or enterprise-grade SLAs on the free tier.
bestFor:
  - rapid prototyping
  - developer testing
  - low-latency AI apps
