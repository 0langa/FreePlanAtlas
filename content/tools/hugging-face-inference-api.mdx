...
description: >-
  Provides hosted inference for popular machine learning models via a simple API
  endpoint.
...
whenToUse: >-
  Use when you need quick, hosted access to popular ML models for prototyping or
  light workloads without managing infrastructure.
whenNotToUse: >-
  Avoid if you need high-throughput, custom models, or guaranteed performance
